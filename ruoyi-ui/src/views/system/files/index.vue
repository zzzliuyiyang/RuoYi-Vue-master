<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="文件上传者ID;上传者姓名" prop="uploadBy">
        <el-input
          v-model="queryParams.uploadBy"
          placeholder="请输入文件上传者ID;上传者姓名"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="活动ID;所属活动名称" prop="activityId">
        <el-input
          v-model="queryParams.activityId"
          placeholder="请输入活动ID;所属活动名称"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="filesList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="文件下载" align="center" prop="file">
      ...
      <el-table-column label="文件上传者ID;上传者姓名" align="center" prop="uploadBy" />
      <el-table-column label="活动ID;所属活动名称" align="center" prop="activityId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="文件上传者ID;上传者姓名" prop="uploadBy">
          <el-input v-model="form.uploadBy" placeholder="请输入文件上传者ID;上传者姓名" />
        </el-form-item>
        <el-form-item label="活动ID;所属活动名称" prop="activityId">
          <el-input v-model="form.activityId" placeholder="请输入活动ID;所属活动名称" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除文件存储编号为"' + fileIds + '"的数据项？').then(function() {
