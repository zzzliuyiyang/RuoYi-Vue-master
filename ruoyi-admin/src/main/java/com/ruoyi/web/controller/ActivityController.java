...
public class ActivityController extends BaseController
{
    ...
    private boolean isTimeConflict(Activity activity) {
        ...
        newResourceState.setResourceId(activity.getResourceId());
        newResourceState.setActivityId(activity.getActivityId());
        newResourceState.setStartDate(activity.getProcessTime());
        newResourceState.setEndDate(activity.getFinishTime());
        resourceStateService.insertResourceState(resourceState);
        return false;
    }
