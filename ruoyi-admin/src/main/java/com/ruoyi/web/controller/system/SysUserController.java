...
public class SysUserController extends BaseController
{
     ...
     */
    @Anonymous
    @PutMapping("/resetPwdNo")
    public AjaxResult resetPwdNo(@RequestBody SysUser user){
        SysUser sysUser = user;
        sysUser.setPassword(SecurityUtils.encryptPassword(user.getPassword()));
        return toAjax(userService.resetUserPwd(sysUser.getUserName(),String.valueOf(sysUser.getPassword()) ));
    }
