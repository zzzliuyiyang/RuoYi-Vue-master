...
CREATE TABLE `append_reply` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='回复评论表';
...
CREATE TABLE `main_reply` (
  ...
  `content` varchar(255) NOT NULL COMMENT '评论内容',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='主评论表';
...
) ENGINE=InnoDB AUTO_INCREMENT=235 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统访问记录';
...
) ENGINE=InnoDB AUTO_INCREMENT=542 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='操作日志记录';
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', '103', 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2024-06-12 14:32:31', 'admin', '2024-04-22 21:16:40', '', '2024-06-12 14:32:30', '管理员');
...
INSERT INTO `sys_user` VALUES ('102', '103', 'lyy', 'lyy', '00', '', '', '1', '', '$2a$10$MEbnnQN5LOkwgZQI.Avuf.1Jxo2tVW4asgMrXDZ5xxthOFQfarNVa', '0', '0', '127.0.0.1', '2024-06-11 21:30:51', '', '2024-06-08 01:11:46', 'admin', '2024-06-11 21:30:50', null);
