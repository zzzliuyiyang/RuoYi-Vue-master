...
INSERT INTO `activity` VALUES ('11', '足球赛', '102', '0', '100.000000', '40.000000', '2024-06-10 00:00:00', '2024-06-28 00:00:00', '2024-06-30 00:00:00', '2024-07-09 00:00:00', null, null, '1', null);
...
CREATE TABLE `activity_user` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='用户和活动关联表';
...
CREATE TABLE `append_reply` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='回复评论表';
...
CREATE TABLE `main_reply` (
  ...
  `content` varchar(255) NOT NULL COMMENT '评论内容',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='主评论表';
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='报销';

-- ----------------------------
-- Records of reimbursement
-- ----------------------------
INSERT INTO `reimbursement` VALUES ('1', '1', '7', '123.00', '0');
INSERT INTO `reimbursement` VALUES ('2', '1', '7', '50.00', '0');
INSERT INTO `reimbursement` VALUES ('3', '1', '7', '500.00', '1');
INSERT INTO `reimbursement` VALUES ('4', '1', '11', '10.00', '0');
...
) ENGINE=InnoDB AUTO_INCREMENT=524 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='操作日志记录';
...
INSERT INTO `sys_user` VALUES ('1', '103', 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2024-06-10 16:33:38', 'admin', '2024-04-22 21:16:40', '', '2024-06-10 16:33:38', '管理员');
...
INSERT INTO `sys_user` VALUES ('102', '103', 'lyy', 'lyy', '00', '', '', '1', '', '$2a$10$MEbnnQN5LOkwgZQI.Avuf.1Jxo2tVW4asgMrXDZ5xxthOFQfarNVa', '0', '0', '127.0.0.1', '2024-06-09 17:25:50', '', '2024-06-08 01:11:46', 'admin', '2024-06-09 17:25:50', null);
INSERT INTO `sys_user` VALUES ('103', '103', 'sch', 'sch', '00', '', '', '0', '', '$2a$10$T4TKmgu.m1yP3CeaunuPXeIfbNb4lxPbv8T44cJYgYCOsdMxY/JWu', '0', '0', '127.0.0.1', '2024-06-09 17:19:12', 'admin', '2024-06-09 17:04:39', 'admin', '2024-06-09 17:19:12', null);
